...
| UC-005 AF-3 | FR-001 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) — [DERIVED, awaiting stakeholder confirmation] | Refines | R001 PoC (Architect, Work Item 7 — deliberately-seeded gaps); SCR-05 (Design Model — compact UI flow reference updated, Elab Iter 2) |
| UC-006 AF-3 | FR-002 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) — [DERIVED, awaiting stakeholder confirmation] | Refines | R001 PoC (Architect, Work Item 7); STD-003 (CSV format — blank cells on missing display attributes); SCR-05 |
| UC-007 AF-3 | FR-003 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) — [DERIVED, awaiting stakeholder confirmation] | Refines | R001 PoC (Architect, Work Item 7); SCR-06 |
