...
| UC-005 AF-3 | FR-001 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) + stakeholder confirmation (Elaboration Iter 2): asked whether the bar applies to all four AD-reading use cases and not only the directory search, the stakeholder answered "Yes" — the AF-3 flow is a confirmed requirement | Refines | R001 PoC (Architect, Work Item 7 — deliberately-seeded gaps); SCR-05 (Design Model — compact UI flow reference updated, Elab Iter 2) |
| UC-006 AF-3 | FR-002 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) + stakeholder confirmation (Elaboration Iter 2): answer "Yes" — the bar applies to all four AD-reading use cases; the AF-3 flow is a confirmed requirement | Refines | R001 PoC (Architect, Work Item 7); STD-003 (CSV format — blank cells on missing display attributes); SCR-05 |
| UC-007 AF-3 | FR-003 + R001 behavioural bar (stakeholder decision, Elaboration Iter 2) + stakeholder confirmation (Elaboration Iter 2): answer "Yes" — the bar applies to all four AD-reading use cases; the AF-3 flow is a confirmed requirement | Refines | R001 PoC (Architect, Work Item 7); SCR-06 |
| UC-005 EF-1 | SEC-006 | Refines | (Supplementary Specification — role enforcement) |
| UC-006 CSV column set | FR-002, CON-005, CON-006, INT-005 + stakeholder decisions (ISO-8601 offset export, local payroll day, office zone America/Havana) | Refines | STD-003 (CSV format); UC-006 AF-2 (abort on AD unavailable); UC-006 AF-3 (blank cells on missing attributes — every event row present) |
