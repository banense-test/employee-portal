...
| ARCH-6 | **Graceful degradation:** a missing AD attribute renders as a blank field; the entry is NEVER hidden from results; a missing attribute NEVER raises an error; **a missing attribute is displayed as missing — it is NEVER replaced by a default, a placeholder, a guessed value, or another employee's value.** | R001 behavioural bar (stakeholder decision, Elab Iter 2 + verdict-gate fourth clause); UC-004 AF-2, UC-005/006/007 AF-3 |
